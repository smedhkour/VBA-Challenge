    ...
    Range("K:K").NumberFormat = "0.00%"
        ...
        For r = 2 To LastRow
            If ws.Cells(r, 1).Value <> ws.Cells(r + 1, 1).Value Then
                ...
                'to both prevent division by 0 and calculate the percent change
               ...
               End If
                ...
                'making sure related row # is looping through the loop
                out_row = out_row + 1
                
            Else
            'the acculation of volume when the tickers match
